...
public class Test {
	...
	public static void main(String[] args) {
		...
		Car car1 = new Car("JX123456708", "Chevrolet", "Malibu", 1976, "Maroon", "09/01/1977");
		dealer.addCar(car1);

		Car car2 = new Car("LG12312489", "Triump", "TR6", 1973, "Green", "08/01/1984");
		dealer.addCar(car2);

		Car car3 = new Car("TY12348908", "Alpha", "Spyder", 1985, "Red", "06/01/1995");
		dealer.addCar(car3);
